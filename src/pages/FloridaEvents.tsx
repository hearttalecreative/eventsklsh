...
const FloridaEvents = () => {
  ...
  const jsonLd = {
    ...
    '@type': 'ItemList',
    name: 'Florida Events - Kyle Lam Sound Healing',
  ...
  // Filter events by Florida
  const floridaEvents = useMemo(
    () => items.filter((ev) => {
      ...
      const isInFlorida = address.includes('florida') || address.includes(', fl');
      return hasTickets && hasImage && isInFlorida;
    }),
    [items]
  );
  ...
  const filtered = useMemo(() => {
    ...
    return floridaEvents.filter((ev) => {
  ...
  return (
    <main>
      <Helmet>
        <title>Florida Events | Kyle Lam Sound Healing</title>
        <meta name="description" content="Discover Kyle Lam Sound Healing events in Florida. Buy tickets for sound healing experiences throughout the Sunshine State." />
        <link rel="canonical" href={`${baseUrl}/events/florida`} />
        <meta property="og:site_name" content="Kyle Lam Sound Healing" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Florida Events | Kyle Lam Sound Healing" />
        <meta property="og:description" content="Discover Kyle Lam Sound Healing events in Florida. Buy tickets for sound healing experiences throughout the Sunshine State." />
        ...
        <meta name="twitter:title" content="Florida Events | Kyle Lam Sound Healing" />
        <meta name="twitter:description" content="Discover Kyle Lam Sound Healing events in Florida. Buy tickets for sound healing experiences throughout the Sunshine State." />
      ...
      <header className="container mx-auto px-4 py-8 text-center">
        <h1 className="text-4xl font-bold">Florida Events</h1>
        <p className="text-muted-foreground mt-2">Sound healing experiences throughout Florida</p>
      </header>
      ...
      <section className="py-6">
        <div className="container mx-auto px-4">
          ...
          {loading ? (
            ...
            <p className="text-sm text-muted-foreground">No events found in Florida.</p>
          ) : (
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {sorted.map((ev) => (
